...
*   **核心差异（中英文对比）**：
    ...
    *   英语：通过名词本身的**形态变化**传递单复数信息 *![](screenshots/screenshot_04f6289ab-95f3-4798-bfeb-dcebb8c3b755.jpg)*
*   **复数构成规则**：
...
*   **可数名词 (Countable Nouns)**：
    ...
    *   **集合名词 (Collective Nouns)**：表示个体组成的集合
        *   单复数意义取决于语境：
            ...
            *   `The team are working together.` (团队成员 - 复数) *![](screenshots/screenshot_1f5577c2c-362e-49bb-a6ce-80cd5b5765bd.jpg)*
        *   特殊集合名词：
    ...
    *   **三种主要形式**：
        1.  **`'s` 所有格**：
            ...
            *   **并列名词规则**：
                ...
                *   各自所有：每个名词后都加 `'s` (e.g., Tom's and Jerry's rooms - 注意 room**s** 用复数) *![](screenshots/screenshot_2596f9256-33a0-46c7-b4a3-281d4882a5d3.jpg)*
        2.  **`of` 所有格**：
            *   构成：`名词A + of + 名词B` -> 表示 `B 的 A` (修饰 A 的性质)
            *   适用对象：常用于无生命名词，**更侧重描述特征而非严格所属** *![](screenshots/screenshot_38b3c15b1-6ac0-4939-a11d-8aa7949cadd9.jpg)*
        ...
        3.  **双重所有格 (Double Genitive)**：
            ...
            *   作用：强调所属关系中的“其中之一” *![](screenshots/screenshot_45e46bffa-a76d-4ea3-9eb2-d818e9fd37d1.jpg)*
                *   `I am a friend of Michael's.` (= I am one of Michael's friends.) (强调我是他众多朋友中的一个)
                *   `a photo of Michael's` (Michael 拥有的照片中的一张)
                *   `a photo of Michael` (照片内容是 Michael 本人) *![](screenshots/screenshot_54dfc2fb5-3cc4-4327-9f71-6720febfdc99.jpg)*
...
*   **名词分类树**：
    *   名词 (Nouns)
        ...
        *   专有名词 (Proper Nouns - e.g., Michael, China) *![](screenshots/screenshot_672804dbc-b0f5-4f6e-9fcd-f2dd0b71ac5f.jpg)*
*   **关键认知**：
